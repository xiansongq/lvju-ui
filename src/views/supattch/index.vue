  ...
  <div class="p-2">
      ...
      <div class="search" v-show="showSearch">
        <el-form :model="queryParams" ref="queryFormRef" :inline="true" label-width="68px">
          ...
          <el-form-item label="ossId" prop="ossId">
            <el-input v-model="queryParams.ossId" placeholder="请输入ossId" clearable style="width: 240px" @keyup.enter="handleQuery" />
          </el-form-item>
          <el-form-item label="文件名称" prop="typeName">
            <el-input v-model="queryParams.typeName" placeholder="请输入文件名称" clearable style="width: 240px" @keyup.enter="handleQuery" />
          </el-form-item>
          <el-form-item label="文件类型值" prop="typeValue">
            <el-input v-model="queryParams.typeValue" placeholder="请输入文件类型值" clearable style="width: 240px" @keyup.enter="handleQuery" />
          </el-form-item>
    ...
    <el-card shadow="never">
      ...
      <el-table v-loading="loading" :data="supattchList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="文件类型值" align="center" prop="typeValue" />
    ...
    <el-dialog :title="dialog.title" v-model="dialog.visible" width="500px" append-to-body>
      <el-form ref="supattchFormRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="文件名称" prop="typeName">
          <el-input v-model="form.typeName" placeholder="请输入文件名称" />
        </el-form-item>
        <el-form-item label="文件类型值" prop="typeValue">
          <el-input v-model="form.typeValue" placeholder="请输入文件类型值" />
        </el-form-item>
        <el-form-item label="是否删除" prop="ideleted">
...
const { lvju_delete_type } = toRefs<any>(proxy?.useDict('lvju_delete_type'));
...
const data = reactive<PageData<SupattchForm, SupattchQuery>>({
  ...
  rules: {
    ...
    ossId: [
      { required: true, message: "ossId不能为空", trigger: "blur" }
    ],
    typeName: [
      { required: true, message: "文件名称不能为空", trigger: "blur" }
    ],
    typeValue: [
      { required: true, message: "文件类型值不能为空", trigger: "blur" }
    ],
    ideleted: [
